...
I have authored over 140 papers in top-tier journals such as **T-RO**, **IJRR**, **ISPRS**, **T-IE**, and **RAL**, and at leading conferences including **ICRA**, **CVPR**, **ICCV**, **NeurIPS**, and **IROS**. My work has been cited over **3,100 times**. I actively serve as a reviewer for all major robotics and vision venues, receiving **Outstanding Reviewer Awards** from **ICRA** and **CVPR**, and the **Best Editorial Award** for community service. I am an **Associate Editor** for *WSPC Unmanned Systems* and a **Guest Editor** for *MDPI Electronics* (Special Issue: *Advanced Technologies of Navigation for Intelligent Vehicles*).
